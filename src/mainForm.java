...
public class mainForm extends javax.swing.JFrame {
    ...
    public mainForm() {
        ...
        this.setTitle(namaApp + " - "+versiApp);
    ...
    private void initComponents() {
        ...
        menuInventory.add(mnAdmin);

        mnGudang.setText("Gudang");
        menuInventory.add(mnGudang);

        mnKategori.setText("Kategori");
        menuInventory.add(mnKategori);

        mnBarang.setText("Barang");
        menuInventory.add(mnBarang);
